...
class EvaluationMetrics(object):
    ...
    def accumulate(self, predictions, labels, loss, hidden_layer_val, hits=1):
        ...
        self.sum_hit_at_one_embedding += hits_at_one_embedding

        return {"hit_at_one": mean_hit_at_one, "perr": mean_perr, "loss": mean_loss,
                "hit_at_one_emb": hits_at_one_embedding}
    ...
    def get(self):
        ...
        print("aaaaaaaa")
        avg_hit_at_one_embedding = self.sum_hit_at_one_embedding / self.num_examples
        ...
        return {"avg_hit_at_one": avg_hit_at_one, "avg_perr": avg_perr,
                "avg_loss": avg_loss, "aps": aps, "gap": gap, "avg_hit_at_one_emb": avg_hit_at_one_embedding}
